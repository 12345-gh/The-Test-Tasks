...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flickr = __webpack_require__(9);
	...
	var gallery = void 0;
	var flickr = new _flickr2.default();
	...
	var Homepage = function () {
		...
		_createClass(Homepage, [{
			key: "searchPhotos",
			value: function searchPhotos(text) {
				if (text.length === 0) {
			...
			value: function init() {
				document.getElementsByClassName('js-form-search')[0].addEventListener('submit', function (event) {
					...
					(0, _debounce3.default)(homePage.submitForm(), 50000);
				});
	...
	window.showPhotos = function (data) {
		gallery = new _gallery2.default(data.photos.photo, document.getElementsByClassName('js-image-list')[0]);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Flickr = function () {
		...
		_createClass(Flickr, [{
			key: 'searchText',
			value: function searchText(parameters) {
			...
			key: 'buildPhotoUrl',
			value: function buildPhotoUrl(photo) {
...
/***/ function(module, exports) {
	...
	var Utility = function () {
		...
		_createClass(Utility, [{
			key: 'buildUrl',
			value: function buildUrl(url, parameters) {
				var queryString = '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Gallery = function () {
		...
		_createClass(Gallery, [{
			key: 'showPhoto',
			value: function showPhoto(index) {
